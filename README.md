...
**Current version:** 0.3.5 — see [CHANGELOG.md](CHANGELOG.md)
...
# → src-tauri\target\release\bundle\nsis\inD3X Art_0.3.5_x64-setup.exe
```
...
# → src-tauri/target/release/bundle/appimage/inD3X Art_0.3.5_amd64.AppImage
```

Full distribution notes: **[docs/DISTRIBUTION.md](docs/DISTRIBUTION.md)**

Tagged releases (`git tag v0.3.5 && git push origin v0.3.5`) are built automatically by GitHub Actions and uploaded to [Releases](https://github.com/ximaks00-hue/ind3x-art/releases).
