...
```bash
chmod +x "inD3X Art_0.3.6_amd64.AppImage"
./"inD3X Art_0.3.6_amd64.AppImage"
```
...
Pushing a tag `v*` (e.g. `v0.3.6`) triggers [`.github/workflows/release.yml`](../.github/workflows/release.yml):
