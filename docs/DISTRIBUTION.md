...
```bash
chmod +x "inD3X Art_0.3.5_amd64.AppImage"
./"inD3X Art_0.3.5_amd64.AppImage"
```
...
Pushing a tag `v*` (e.g. `v0.3.5`) triggers [`.github/workflows/release.yml`](../.github/workflows/release.yml):
